...
class _VideoViewerState extends ConsumerState<VideoViewer> with WidgetsBindingObserver {
                                        ...
                                        return GestureDetector(
                                          onTap: () async {
                                            AudioPlayer().play(
                                                AssetSource("audio/Bubble 02.mp3"));
                                            final prefs = await SharedPreferences.getInstance();
                                            final filePath = prefs.getString("${i['title']}.mp4");
                                            final fileImage = prefs.getString("image${i['title']}.mp4");
                                            ...
                                            if (filePath != null && await File(filePath).exists()) {
                                              ...
                                              if (!isOnline) {
                                                ...
                                                await _initializePlayer(i['video_url']);
                                              }
                                            }
